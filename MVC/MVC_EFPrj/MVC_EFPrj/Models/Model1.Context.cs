...
namespace MVC_EFPrj.Models
{
    ...
    public partial class NorthWindDBContext : DbContext
    {
        ...
        [DbFunction("NorthWindDBContext", "GetCustomersByCountry")]
        public virtual IQueryable<GetCustomersByCountry_Result> GetCustomersByCountry(string country)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetCustomersByCountry_Result>("[NorthWindDBContext].[GetCustomersByCountry](@country)", countryParameter);
        }
